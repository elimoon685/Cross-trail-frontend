...
return (
    ...
    <div className="bg-[#FF3B30] h-30 flex items-center px-10 gap-10">
        ...
        <FaShoppingCart className="h-6 w-6 text-white" onClick={()=>setOpen(prev=>!prev)}/>
        </div>
    </div>
    <div className={`fixed top-0 right-0 min-h-screen w-[400px] bg-white transform transition-transform duration-500 ${open ? "translate-x-0" : "translate-x-full"} z-50`}>
